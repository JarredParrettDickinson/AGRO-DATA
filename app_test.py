...
def make_geo_json(df):
    ...
    for _, row in df.iterrows():
        ...
        poly = Polygon(geometry=tuple_list, coordinates=tuple_list)
        dict_ft = {}#make_properties_dict(row)
        feature = Feature(geometry=poly, properties=dict_ft)
        feature_array.append(feature)
    feature_collection = (FeatureCollection(feature_array))
